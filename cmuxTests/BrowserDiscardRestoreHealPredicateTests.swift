...
/// made with a bare `BrowserDiscardRestoreNavigationStub.make()` carries unconstructed storage. Allocating one is harmless;
...
struct BrowserDiscardRestorePolicyCancelTests {
    ...
    @Test func staleInsecureHTTPPromptDoesNotCompleteNewerRestore() throws {
        ...
        // Roughly forty other window-closing sites in cmuxTests do the same.
